...
import com.nlu.QLDN3.db.NoSuchNhanVienException;
import com.nlu.QLDN3.db.model.NhanVien;
import com.nlu.QLDN3.db.model.impl.NhanVienImpl;
import com.nlu.QLDN3.db.model.impl.NhanVienModelImpl;
...
public class NhanVienPersistenceImpl extends BasePersistenceImpl<NhanVien>
	 ...
	 */
	@Override
	public NhanVien create(String maNhanVien) {
		NhanVien nhanVien = new NhanVienImpl();

		nhanVien.setNew(true);
		nhanVien.setPrimaryKey(maNhanVien);
	 ...
	 */
	@Override
	public NhanVien remove(String maNhanVien)
		throws NoSuchNhanVienException, SystemException {
		return remove((Serializable)maNhanVien);
	}
	...
	@Override
	public NhanVien updateImpl(com.nlu.QLDN3.db.model.NhanVien nhanVien)
	...
	protected NhanVien toUnwrappedModel(NhanVien nhanVien) {
		...
		nhanVienImpl.setMaNhanVien(nhanVien.getMaNhanVien());
		nhanVienImpl.setMaCongTy(nhanVien.getMaCongTy());
		nhanVienImpl.setTenNhanVien(nhanVien.getTenNhanVien());
		nhanVienImpl.setNgaySinh(nhanVien.getNgaySinh());
		nhanVienImpl.setGioiTinh(nhanVien.getGioiTinh());
		nhanVienImpl.setSDT(nhanVien.getSDT());
		nhanVienImpl.setNgayVaoLam(nhanVien.getNgayVaoLam());
	 ...
	 */
	@Override
	public NhanVien findByPrimaryKey(String maNhanVien)
		throws NoSuchNhanVienException, SystemException {
		return findByPrimaryKey((Serializable)maNhanVien);
	}
	 ...
	 */
	@Override
	public NhanVien fetchByPrimaryKey(String maNhanVien)
		throws SystemException {
		return fetchByPrimaryKey((Serializable)maNhanVien);
	}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.nlu.QLDN3.db.model.NhanVien")));
