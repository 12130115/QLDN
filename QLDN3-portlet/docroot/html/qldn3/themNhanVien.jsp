...
<portlet:actionURL name="themNhanVien" var="themNhanVienURL"/>
<h3>Them nhan vien</h3>
<aui:form action="<%=themNhanVienURL.toString()%>" method="post">
<aui:fieldset>
	<aui:input name="maNhanVien" type="text" value="">
	</aui:input>
	<aui:input name="maCongTy" type="text" value="">
	</aui:input>
	<aui:input name="tenNhanVien" type="text" value="">
	</aui:input>
	<aui:input name="ngaySinh" type="text" value="">
	</aui:input>
	<aui:input name="SDT" type="text" value="">
	</aui:input>
	<aui:input name="ngayVaoLam" type="text" value="">
	</aui:input>
